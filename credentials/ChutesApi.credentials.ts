...
export class ChutesApi implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		{
			displayName:
				"The above OAuth Redirect URL is auto-generated by n8n and is not used - just enter a Chutes API Key or click 'Connect my account' below.",
			name: 'oauthRedirectHelp',
			type: 'notice',
			default: '',
		},
		{
			...
			hint: "Use 'Sign in With Chutes' below (OAuth) or create a Chutes API key from your Chutes dashboard at chutes.ai/app/api ",
		},
		{
		...
		{
			displayName:
				"'Sign in With Chutes' has not been configured on this n8n instance. Please contact your administrator to register this app with Chutes.ai and set CHUTES_OAUTH_CLIENT_ID and CHUTES_OAUTH_CLIENT_SECRET in the server environment. ( see: https://github.com/chutesai/Sign-in-with-Chutes )",
